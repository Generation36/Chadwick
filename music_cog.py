...
class music_cog(commands.Cog):
    ...
    @commands.command(name="play", aliases=["p","playing", "play_music"], help="Play the selected song from youtube")
    ...
    @commands.command(name="clear", aliases=["clear_queue"], help="Clears the music queue")
